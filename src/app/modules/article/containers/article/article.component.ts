import { Component, OnInit, ViewContainerRef, ViewChild, ComponentFactoryResolver, ComponentFactory, ComponentRef, ElementRef } from '@angular/core';
...
export class ArticleComponent implements OnInit {
  ...
  public image = "https://www.elite-corner.com/wp-content/uploads/2018/11/angular-ngFor-directive-min.jpg";
  public article = [
...
*ngFor="let item of menu; let odd = odd"</code>`,
  ...
  ngAfterViewInit() {
    this.article.filter((p, i) => i > 0).map(indent => this.createComponent(indent));
  }
